...
example, a microbean-helm version of `2.7.0.1.0.39` means that the Helm
version it tracks is `2.7.0` and the (SemVer-compatible) version of
the non-generated code that is part of _this_ project is `1.0.39`.
